...
public class User implements java.io.Serializable {
	...
	public User(String id, Role role, String name, String contact, Date birth, String introduce, String email,
			String password, String headImage, String gender, String address, String status, Date registerTime,
			Integer visitedCount, Institution institution, Set mailsForSenderId, Set supplies,
			Entrepreneur entrepreneur, Tutor tutor, Set mailsForReceiverId, Set friendsForFollowerId, Set operationLogs,
			Set friendsForFolloweeId, Set notices, Set needs, Set userLabels) {
		this.id = id;
		this.role = role;
		this.name = name;
