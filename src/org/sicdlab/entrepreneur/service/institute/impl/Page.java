...
public class Page {
	...
	private List<Institution> recordList; // 本页的数据列表
	//计算
	...
	public Page(int pageSize,int currentPage,int recordCount,List<Institution> recordList){
	...
	public List<Institution> getRecordList() {
		return recordList;
	}
	public void setRecordList(List<Institution> recordList) {
		this.recordList = recordList;
	}
