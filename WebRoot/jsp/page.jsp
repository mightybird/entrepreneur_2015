	...
	<div style="width: 1880px; height: 240px; margin-left: 20px;">
		...
		<div>
			<div class="panel-body"
				style="width: 350px; height: 50px; margin-left: 400px; float: left; margin-top: 10px;">
			...
			<ul class="pagination">
				...
				<s:iterator begin="%{beginPageIndex }" end="%{endPageIndex}"
					...
					<s:if test="#num == currentPage">
						<li class="active"><a>${num }<span class="sr-only">(current)</span>
							</a></li>
					</s:if>
					<%--非当前页 --%>
					<s:else>
				...
				<%--尾页 --%>
				<li><a href="javascript:gotoPageNum(${pageCount })"
						style="cursor: hand;">尾页</a></li>
				<li></li>
				<li>&nbsp&nbsp&nbsp第&nbsp&nbsp<select
					onchange="gotoPageNum(this.value)" id="_pn"
					style="padding: 5px 0; margin: 2px 0 0; border: 1px solid #d0d0d0; width: 80px; height: 32px; border-radius: 3px;">
						<s:iterator begin="1" end="%{pageCount }" var="num">
							<option value="${num }">${num }</option>
						</s:iterator>
				</select>&nbsp&nbsp页&nbsp&nbsp
				</li>
				<li>共 &nbsp ${pageCount } &nbsp 页</li>
			</ul>
		</div>
		<%--分页 跳转--%>
		<%-- <div>
		...
		<div>
			<ul class="pager">
				<s:if test="currentPage == 1&&pageCount!=1&&pageCount!=0">
					...
					<li class="next"><a onclick="gotoPageNum(${currentPage+1 });"
				...
				<s:elseif test="currentPage==#num">
					...
					<li class="previous"><a
							onclick="gotoPageNum(${currentPage-1 });" style="cursor: hand;"></a></li>
				</s:elseif>
