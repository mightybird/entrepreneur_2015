(function ($) { $.fn.TagsInput = function (options) {  var defaults = { usedTags: "", hotTags: "", tagNum: 0, maxWords: 0 }; 
var opts = $.extend(defaults, options); 
var $this = $(this); $this.hide(); 
var arrayTags; var strHtml;
...
strHtml += "</div><div class=\"layer-tags-wrapper\">"; if (opts.usedTags != "") { strHtml += "<div class=\"clearfix layer-tags-box\"><div class=\"layer-tags-left\">记忆标签</div><div class=\"layer-tags-right\">"; arrayTags = opts.usedTags.split('|'); 
...
arrayTags = opts.hotTags.split('|'); for (i = 0; i < arrayTags.length; i++)
{ strHtml += "<a class=\"layer-tag-name\" href=\"javascript:;\">" + arrayTags[i] + "</a>"; }
strHtml += "</div></div>"; }
